...
/**
 * Created by Merjiezo on 2017/11/20.
 */
public class ApiNoAuthException extends RuntimeException {
     ...
     * @param message 异常信息
     */
    public ApiNoAuthException(String code, String message) {
        super(message);
        this.status = code;
    }
    ...
    public ApiNoAuthException(String code, String message, Throwable throwble) {
